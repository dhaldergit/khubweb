		...
		<script>
			...
			function populateTrendGraph(){
				...
				$('#loading').show();
					...
					$.ajax({
						url : ctx + "/ProposalServlet?khubPageId=metricsPatReqPage",
						success : function(result) {
							
							var ele = document.createElement("img");
							ele.setAttribute("src", "/images/PieChartPatReqBySector.jpeg");
							ele.setAttribute("height", "480");
							ele.setAttribute("width", "640");
document.getElementById("hitsGraph").appendChild(ele);

 var elem = document.createElement("img");
elem.setAttribute("src", "/images/PieChartPatTcvBySector.jpeg");
	 ...
	 cEle.appendChild(headerElement);
			...
			function populateTrendReport() {
				...
				var ctx = "<%=request.getContextPath()%>";
					...
					//console.log(formVals);
					$.ajax({
						url : ctx + "/ProposalServlet?khubPageId=feedBackMetricsPage",
						success : function(result) {
							var res = JSON.stringify(result);
			 ...
			 */
			 ...
			 if(x == 0) {
				...
				// commonElement.setAttribute("rowspan","2");
				 commonElement.innerHTML = "Serial No.";
				 headerElement.appendChild(commonElement);
			 ...
			 var cell2 = document.createElement('td');
				...
				chEle.appendChild(cell2);
								...
								cell1.setAttribute('id', "r"+i+"_"+j);
								if(j == "comments") {
									cell1.setAttribute("style","overflow: hidden; max-width: 400px; word-wrap: break-word; ");
								}
			...
			<div id="main">
				<div class="mid-data-container">
					...
					<div id="breadcrumb-holder">
						<a href='index.html'>Home</a> > Metrics
					</div>
					<!-- Breadcrumb End -->
...
<h1>Feedback Data</h1>
  ...
  <br><br>
  <!-- <h1>TCV Wise Distribution Raw Data</h1> -->
