    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><span style="height: 60px;width: 60px; display:block;margin:-5px;"><img src="../images/PAT_arrow_prev.gif"></span></div><div class="' + SLIDES_ARROW_NEXT + '"><span style="height: 60px;width: 60px; display:block;margin:-5px;"><img src="../images/PAT_arrow_next.gif"></span></div>');
