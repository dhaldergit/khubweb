...
<div class="sidebar col-md-3">
                            ...
                            <input type="button"  class="srh" value="Search" onclick="searchFil();"><br></div></div>
																<div class="well">
																<fieldset>
																<legend>Service Line</legend></fieldset>
																<fieldset>
																...
																<div class="well"><fieldset><legend>Growth Area</legend>
                                                                     ...
                                                                     <div id="double_date_range" ></div>
                                                                      ...
                                                                      <br> 
                                                                      <!-- hidden types start -->
<input type="hidden" id="type" name="type" value="Proposals">
<input type="hidden" id="minDate" name="minDate" value="">
<input type="hidden" id="maxDate" name="maxDate" value="">
<!-- hidden types end -->
                                                                    <div class="searchholder">
								<div class="searchholder-in"> <input class="srh" type="button"  value="Search"
...
<!-- 					<div class="pat-head">
					...
					<div id="breadcrumb-holder">
						<a href='index.jsp'>Home</a> > Proposal Bank
					</div>
					<!-- Breadcrumb End -->
