 ...
 */
 ...
 $(document).on('click',".checkAll",function (e) {
  ...
  $(document).ready(function(){
	   ...
	   var pm =  get("industryList");
	   //alert(pm);
	   if(pm == undefined) {
	   populateBas("");
	   } else {
	    populateBas("industryList=" + pm);
	   }
	});
...
function populateBas(obj) {
	...
	//var ctx = "<%=request.getContextPath()%>";
		...
		$.ajax({
			...
			url :  "/ProposalServlet?khubPageId=proposalPage&" + obj +"&type=" +type,
                            ...
                            <input type="button" class="srh" value="Search" onclick="searchFil();"><br></div></div>
																...
																<!-- <div class="well" style="height: 12em;  overflow: auto;"><fieldset><legend>Growth Area</legend>
                                                                     ...
                                                                     <div id="double_date_range" ></div>
                                                                      ...
                                                                      <br> 
                                                                      <!-- hidden types start -->
<input type="hidden" id="type" name="type" value="Market Insights">
...
<!-- hidden types end -->
					...
					<div id="breadcrumb-holder">
						<a href='index.jsp'>Home</a> > Market  Insight
					</div>
